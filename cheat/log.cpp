...
#define _CRT_SECURE_NO_WARNINGS
        ...
        SetConsoleTitleA("GuysServicesV3 GTA5 Mod Menu");
...
#else
            MessageBoxA(NULL, init_fail.str().c_str(), "GuysServicesV3 GTA5 Mod Menu", MB_OK);
#endif
        }

#ifndef LOG_NO_CONSOLE
        std::cout << "GuysServicesV3 GTA5 Mod Menu - version " << build_info::VersionString << std::endl;
#endif
